...
export default async function HomePage({ searchParams }: PageProps) {
  ...
  const translations = {
    en: {
      ...
      accraTitle: "Accra, Ghana",
      accraDesc: "National Visa (Aupair) at the German Embassy",
    ...
    de: {
      ...
      accraTitle: "Accra, Ghana",
      accraDesc: "Nationalvisa-Termine (Aupair)",
      windhoekTitle: "Windhoek, Namibia",
  ...
  const embassies = [
    ...
    },
    {
      id: 'accra',
      title: t.accraTitle,
      description: t.accraDesc,
      href: `/accra${currentLanguage === 'de' ? '?lang=de' : ''}`,
      color: 'from-yellow-50 to-white',
      borderColor: 'border-yellow-200',
      icon: (
        <svg className="w-6 h-6 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
