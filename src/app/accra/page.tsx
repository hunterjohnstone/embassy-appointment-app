...
function HomeContent() {
  ...
  const translations = {
    de: {
      ...
      heroSubtitle: "Für Nationalvisa-Termine (Au Pair) an der Deutschen Botschaft in Accra",
      ...
      copyright: "Deutsche Botschaft Accra Termin Finder",
      
      // Tier translations - Updated to match English
      freeTier: "Basic",
      paidTier: "€14,99",
      freePrice: "Kostenlos",
      paidPrice: "Zur Kasse (€14,99)",
      ...
      howItWorksDesc: "Unser System überwacht kontinuierlich die Website der Deutschen Botschaft auf verfügbare Termine für Nationalvisa (Au Pair).",
      features: [
        "Automatische Überwachung der Botschafts-Website",
        "CAPTCHA-Erkennung und -Lösung",
        "Prüfung auf Nationalvisa-Termine (Au Pair)",
    ...
    en: {
      ...
      heroSubtitle: "For National Visa (Au Pair) appointments at the German Embassy in Accra",
      ...
      copyright: "German Embassy Accra Appointment Finder",
      ...
      howItWorksDesc: "Our system continuously monitors the German Embassy website for available National Visa (Au Pair) appointments.",
      features: [
